  ...
  return (
    <div className="w-full max-w-xs m-auto">
      ...
      <button
        ...
        type="button"
        class="text-white bg-[#ef4444] hover:bg-[#f87171]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2 w-full"
      >
        <svg
          class="w-4 h-4 me-2"
          aria-hidden="true"
